                                ...
                                @foreach ($jadwals as $jadwal)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 align-middle">
                                            ...
                                            @else
                                                <span class="px-2 py-1 bg-red-200 text-red-800 rounded text-xs">Nonaktif</span>
                                            @endif
                                        </td>
                                        <td class="px-4 py-2 align-middle flex items-center gap-2">
                                            <form action="{{ route('dokter.jadwal.toggle-status', $jadwal->id) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="px-3 py-1 {{ $jadwal->status ? 'bg-red-600 hover:bg-red-800' : 'bg-green-600 hover:bg-green-800' }} text-white rounded transition text-sm">
